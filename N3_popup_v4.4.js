...
x$(document).ready(function() {
  ...
  }), x$("DIV.date-count-down-2").load("/main/authorization/signIn? .site-body.container-fixedFull.signInPage.signInFlow"), x$("A#date-count-down, A#date-count-down1").live("click", function(a) {
...
if (null === ning.CurrentProfile) {
  ...
  var GEOCOMpu = document.getElementsByTagName("body")[0], GEONodepu = document.createElement("link");
  GEONodepu.type = "text/css";
  GEONodepu.rel = "stylesheet";
  GEONodepu.media = "screen";
  GEOCOMpu.appendChild(GEONodepu);
  GEONodepu.href = "//api.ning.com/files/D4tgE4d4mNruBR6k1TW9IpL5BoY10SMRG*wSr6iJDERTSFNrm-Jma379l8258SJ-pEYoplM4MunKJk3ucnp8DyL17mA2cuHr/G_P_U.css";
}
